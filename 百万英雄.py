...
def get_screenshot():
    ...
    # 切出题目
    title_img = img.crop((70, 260, 1025, 590))
    # 切出答案
    answers_img = img.crop((70, 590, 1025, 1260))
    # 拼接
    new_img = Image.new('RGBA', (955, 1000))
    new_img.paste(title_img, (0, 0, 955, 330))
    new_img.paste(answers_img, (0, 330, 955, 1000))
    # 内存对象
    new_img_fb = BytesIO()
